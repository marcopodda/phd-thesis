...
\end{itemize}
Basically, for our purposes, a \gls{ppn} is a tuple $\wp = \Tuple{\Cal{P},\Cal{T},\Cal{A}_{S}, \Cal{A}_{P},\Cal{A}_{I}}$ where the irrelevant components have been omitted. We rewrite this object, according to the graph notation introduced in Section \ref{sec:graphs}, into a \keyword{pathway graph} $\Graph{g} = \Tuple{\Nodes_{\Graph{g}}, \Edges_{\Graph{g}}}$. To do so, we first define the following nodes and edges subsets:
\begin{itemize}
