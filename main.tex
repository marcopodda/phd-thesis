...
\supervisor{Dr. Davide \textsc{Bacciu}\\Prof. Alessio \textsc{Micheli}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\university{\href{http://www.university.com}{University of Pisa}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
\group{\href{http://researchgroup.university.com}{Computational Intelligence and Machine Learning Group}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
...
\part{Deep Graph Networks Applied to Computational Biology}
\include{Chapters/Chapter4}
\include{Chapters/Chapter5}
\part{Deep Generative Learning on Graphs Applied to Computational Chemistry}
